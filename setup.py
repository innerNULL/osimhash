...
class CMakeBuild(build_ext):
    def build_extension(self, ext):
        ...
        cmake_args = [
            ...
            "-DOSIMHASH_BENCHMARK=OFF", 
            "-DOSIMHASH_PY_BIND=ON"
        ]
        build_args = []
...
setup(
    ...
    author="innerNULL",
    author_email="",
    description="A deduplication lib built Over SIMHASH",
    long_description="See 'https://github.com/innerNULL/osimhash'.",
    #python_requires='>=3.7, <3.10',
    ext_modules=[CMakeExtension("pyosimhash")],
    cmdclass={"build_ext": CMakeBuild},
    zip_safe=False,
    url="https://github.com/innerNULL/osimhash", 
